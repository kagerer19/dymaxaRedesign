...
const PrivacyPolicy = ({isOpen, onAccept, onClose}) => {
            ...
            <Box sx={style}>
                ...
                <Typography id="modal-modal-description" sx={{mt: 2}}>
                    ...
                    <Container className={'privacy-policy'}>
                        ...
                        <ul>
                            ...
                            <li>
                                <p><strong>Company</strong> (referred to as either &quot;the
                                    ...
                                    refers to Dymaxa Recruitment Solutions, Cape Town, South Africa.</p>
                            </li>
                            <br/>
                            <li>
                            ...
                            <li>
                                <p><strong>Device</strong> means any device that can access the Service such as a
                                    computer, a cell phone or a digital tablet.</p>
                            </li>
                            <br/>
                            <li>
                            ...
                            <br/>
                            <li>
                                <p><strong>Website</strong> refers to Dymaxa Recruitment Solutions, accessible from <a
                                    href="https://dymaxa.co.za/" rel="external nofollow noopener"
                                    target="_blank">https://dymaxa.co.za/</a></p>
                            </li>
                            <br/>
                            <li>
                        ...
                        <ul>
                            <li>
                                <p>By email: hayley@dymaxa.co.za</p>
                            </li>
                            <li>
                                <p>By visiting this page on our website: <a href="https://dymaxa.co.za/contact/"
                                                                            rel="external nofollow noopener"
                                                                            target="_blank">https://dymaxa.co.za/contact/</a>
                                </p>
                            </li>
                        </ul>
                    </Container>
