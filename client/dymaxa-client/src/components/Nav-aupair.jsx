...
import {
    ...
    BriefcaseIcon,
    UserPlusIcon, PhoneIcon,
} from '@heroicons/react/24/outline'
import {HomeIcon} from "@heroicons/react/24/outline/index.js";

const solutions = [
    { name: 'Au-pair Home', description: 'Get a better understanding of who we are', href: '#', icon: HomeIcon },
...
function NavAupair() {
    return (
        <Popover className="relative">
            ...
            >
                <Popover.Panel className="absolute z-10 mt-5 flex w-screen max-w-md left-[-39%] transform -translate-x-1/2 px-4">
